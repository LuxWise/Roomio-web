      ...
      <LayoutLogin>
        <section className=" flex flex-col w-2/6 h-full items-center  pt-36 px-10 bg-white">
          <div className="flex flex-col items-center mb-8 ">
            ...
            >
              Inicia sesión para acceder a tu cuenta y disfrutar de todos
              nuestros servicios. Por favor, ingresa tus datos en el formulario.
            </Typography>
          </div>
          <InputForm
            title="Iniciar Sesion"
            titleButton="Ingresar en Roomio"
            fields={[
              { name: "Email", type: "text", placeholder: "Nombre" },
              { name: "contraseña", type: "password", placeholder: "Apellido" },
            ]}
